...
class ExecuteClassifying {
  ...
  private static void demonstrateSerialization()
    ...
    Classifier<String,String> cl =
            cdc.makeClassifier(cdc.readTrainingExamples(where + "examples/WebApiDataset.train"));
    ...
    ois.close();
    ColumnDataClassifier cdc2 = new ColumnDataClassifier(where + "examples/WebApiDataset.prop");
  ...
  private static void demonstrateSerializationColumnDataClassifier()
    ...
    ColumnDataClassifier cdc = new ColumnDataClassifier(where + "examples/WebApiDataset.prop");
    cdc.trainClassifier(where + "examples/WebApiDataset.train");
